...
with hand_model.Hands(min_detection_confidence=0.6, min_tracking_confidence=0.5) as hands:
    while True:
        ...
        if result.multi_hand_landmarks:
            for hand_landmark in result.multi_hand_landmarks:
                index_finger_point = hand_landmark.landmark[8]
                ...
                if 250 < x < 500 and 150 < y < 250:
                    ...
                    cv2.putText(frame, "Button Pressed!", (50, 50), cv2.FONT_ITALIC, 2, (255, 0, 0), 2)
